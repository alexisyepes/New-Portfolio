  ...
  render() {
    return (
      <div className="mainBox-projects">
        <div>
          <a target="blank" href="https://github.com/alexisyepes/trainSchedule">
            <button type="button" class="fixed btn btn-info p0title-btn1">
              Github
            </button>
          </a>
          <a target="blank" href="https://alexisyepes.github.io/trainSchedule/">
        ...
        <div className="container project1Box">
          ...
          <div className="row projectPair">
            ...
            <div className="col-md-6 project1TextBox">
              ...
              <p className="p9projectParag">
                Moment.js was used to handle time in this app. Simple app where
                the users can add trains to the Schedule and arrival time and
                frequency will be added automatically to the table.
              </p>
