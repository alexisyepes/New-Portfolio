...
export default class index extends Component {
    render() {
        return (
            <div>
                <div>
                    <a target="blank" href="https://github.com/alexisyepes/newsScraper"><button type="button" class="fixed btn btn-info title-btn1">Github</button></a>
                    <a target="blank" href="https://alexyepesnewscraper.herokuapp.com/"><button type="button" class="btn btn-info title-btn2">Live site</button></a>
