  ...
  render() {
    return (
      <div className="mainBox-projects">
        <div>
          <a target="blank" href="https://github.com/alexisyepes/eventPlanner">
            <button type="button" class="fixed btn btn-info p0title-btn1">
              Github
            </button>
          </a>
          <a target="blank" href="https://fast-springs-87530.herokuapp.com/">
        ...
        <div className="container project1Box">
          ...
          <div className="row projectPair">
            ...
            <div className="col-md-6 project1TextBox">
              <br />
              <h3 className="p5descriptionTitle">
                <b>Description</b>
              </h3>
              <p className="p5projectParag">
                Event Planner A web server with registered API endpoints,
                pushing dynamically built html from handlebar templates with SQL
                data. We have built an event planner app with UIs for event
                planners and another for event attendees.
              </p>
            </div>
          </div>
          ...
          <div className="row projectPair">
            ...
            <div className="col-md-6">
              <img
                alt="project1"
                src="./images/project5ThirdPic.png"
                className="project5ThirdPic"
              ></img>
            </div>
          </div>
        </div>
