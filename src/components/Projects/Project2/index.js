        ...
        <div className="container project1Box">
          ...
          <div className="row projectPair">
            ...
            <div className="col-md-6 project2TextBox">
              <h2 className="p2descriptionTitle">
                <b>Description</b>
              </h2>
              <p className="proj2projectParag">
                This is a Full-stack app made with google-book APIs and React.
                All types of books are available through google-play store, but
          ...
          <div className="row projectPair">
            <div className="col-md-6">
              <img
                alt="project1"
                src="./images/project2SecondPic.png"
                className="project1"
              ></img>
            </div>
            <div className="col-md-6 project1TextBox">
              <h2 className="p2buildingTitle">
                <b>Building Tools</b>
              </h2>
              <br />
            ...
            <div className="col-md-6 p2thirdImg">
              <img
                alt="project1"
                src="./images/project2ThirdPic.png"
                className="project2ThirdPic"
              ></img>
            </div>
          </div>
        </div>
