  ...
  render() {
    return (
      <div className="mainBox-projects">
        <div>
          <a target="blank" href="https://github.com/alexisyepes/friend-finder">
            <button type="button" class="fixed btn btn-info p0title-btn1">
              Github
            </button>
          </a>
          <a target="blank" href="https://blooming-dusk-13977.herokuapp.com/">
        ...
        <div className="container project1Box">
          ...
          <div className="row projectPair">
            ...
            <div className="col-md-6 project1TextBox">
              ...
              <p className="p7projectParag">
                This is a compatibility-based "FriendFinder" application --
                basically a dating app. This full-stack site will take in
                results from your users' surveys, then compare their answers
