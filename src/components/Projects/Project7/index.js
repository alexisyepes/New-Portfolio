...
export default class index extends Component {
    render() {
        return (
            <div>
                <div>
                <a target="blank" href="https://github.com/alexisyepes/friend-finder"><button type="button" class="fixed btn btn-info title-btn1">Github</button></a>
                <a target="blank" href="https://blooming-dusk-13977.herokuapp.com/"><button type="button" class="btn btn-info title-btn2">Live site</button></a>
            ...
            <div className="container project1Box">
                ...
                <div className="row projectPair">
                    ...
                    <div className="col-md-6 project1TextBox">
                        <h2>Description</h2>
                        <p className="projectParag" style={{ fontSize: "18px" }}>This is a compatibility-based "FriendFinder" application -- 
